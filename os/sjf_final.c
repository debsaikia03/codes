...
void main() {
    ...
    int front=-1; // increamented for popping
    int rear=-1; // increamented for pushing
    ...
    while(1){
        ...
        while (t==INPUTS[next_process_in_INPUTS].arrival_time){
            ...
            if (strcmp(scheduling_algo,"FCFS")==0){
                ...
                for (int i=rear;;i--){
                    if (i==-1 || process_queue[i].burst_time<=INPUTS[next_process_in_INPUTS].burst_time){
                         process_queue[i+1]=INPUTS[next_process_in_INPUTS];
                         rear++;
                         break;
                    }
                    else{
